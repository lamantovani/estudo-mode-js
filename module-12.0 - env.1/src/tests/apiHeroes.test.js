...
const TOKEN = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6Inh1eGFkYXNpbHZhIiwiaWQiOjEsImlhdCI6MTU0ODM0Njg3MH0.ExNGSJWYLALqJMCb3tzwSdC9YM47Z_cNyRImWBJDiPQ'
...
describe('Suite de testes da API Heros', function () {
    ...
    it('Atualizar PATCH - /herois/:id - não deve atualizar com id incorreto', async () => {
        const _id = `5c49bb0e23d2ad077f4dca7b`
        const expected = {
            poder: 'Super Mira'
        }
        const result = await app.inject({
        ...
        assert.deepEqual(dados, expected1)
    })
